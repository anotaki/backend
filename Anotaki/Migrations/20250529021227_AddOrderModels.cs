        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductExtras_Extras_ExtraId",
                        column: x => x.ExtraId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExtraId = table.Column<int>(type: "integer", nullable: false),
                    OrderProductItemId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderExtraItems", x => x.id);
                    table.ForeignKey(
                        name: "FK_OrderExtraItems_Extras_ExtraId",
                        column: x => x.ExtraId,
                        principalTable: "Extras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderExtraItems_OrderProductItems_OrderProductItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderExtraItems_ExtraId",
                table: "OrderExtraItems",
                column: "ExtraId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderExtraItems_OrderProductItemId",
                table: "OrderExtraItems",
